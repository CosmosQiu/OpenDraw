...
export const onCanvasNodePickerState =
  new EditorAtom<OnCanvasNodePickerState | null>(
    ...
    <OnCanvasNodePickerDialog onClose={onClose}>
      <TldrawUiMenuGroup id="inputs">
        <OnCanvasNodePickerItem
          definition={nodeDefs.prompt}
          onClose={onClose}
        />
        <OnCanvasNodePickerItem
          definition={nodeDefs.load_document}
          onClose={onClose}
        />
        <OnCanvasNodePickerItem
          definition={nodeDefs.load_audio}
          onClose={onClose}
        />
        <OnCanvasNodePickerItem
          definition={nodeDefs.load_image}
          onClose={onClose}
        />
      </TldrawUiMenuGroup>
      <TldrawUiMenuGroup id="process">
        <OnCanvasNodePickerItem
          definition={nodeDefs.generate}
          onClose={onClose}
        />
        <OnCanvasNodePickerItem
          definition={nodeDefs.generate_music}
          onClose={onClose}
        />
        <OnCanvasNodePickerItem
          definition={nodeDefs.generate_video}
          onClose={onClose}
        />
        <OnCanvasNodePickerItem
          definition={nodeDefs.generate_text}
          onClose={onClose}
        />
        <OnCanvasNodePickerItem
          definition={nodeDefs.reverse}
          onClose={onClose}
        />
      </TldrawUiMenuGroup>
      <TldrawUiMenuGroup id="output">
        <OnCanvasNodePickerItem
          definition={nodeDefs.preview}
          onClose={onClose}
        />
      </TldrawUiMenuGroup>
...
function OnCanvasNodePickerDialog({
  ...
  const location = useValue(
    "location",
    () => onCanvasNodePickerState.get(editor)?.location,
    [editor],
  );
  ...
  useQuickReactor(
    ...
    () => {
      ...
      const terminalInViewportSpace =
        editor.pageToViewport(terminalInPageSpace);
